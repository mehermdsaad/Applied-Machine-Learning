...
class CartpoleEnvV1(gym.Env):
    ...
    def _process_state(self):
        ...
        processed_state = np.array(
            [
                ...
                self.prevState[0],
                self.prevState[2],
                # self.prevState[0], # OLD BUGG, IGNORE
                # self.prevState[1], # OLD BUGG, IGNORE
            ]
        )
        # we keep the previous x, theta along with the current x and theta as our state
    ...
    def reset(self, seed=None, options=None):
        ...
        # initially just let it be the same as the state
    ...
    def step(self, action):
        ...
        # We try keeping the previous x, theta to see if it makes the system markovian
        self.prevState = x_tmp
        # Full system state
        self.state = np.array(
            [
                x,
