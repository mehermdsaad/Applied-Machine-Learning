...
class CartpoleEnvV0(gym.Env):
    ...
    def render(self, str=""):
        ...
        #######################################################################
        # Initialize font
        font = pygame.font.Font(None, 24)  # Choose the font and size you prefer

        # Render text
        text_surface = font.render(str, True, (0, 0, 0))  # Text, antialiasing, color

        # Position of the text
        text_rect = text_surface.get_rect()
        text_rect.center = (self.screen_width // 2, 50)  # Adjust the position as needed
